...
\midrule
Chemistry Retrieval & ChemTEB(latest)$^{\dagger}$
& 3 & 1682 & $34,153$ & 0.746 & 0.741 & 0.728 \\
Open-domain Retrieval & MTEB Retrieval
& 10 & 1482 & $109,645$ & 0.544 & 0.467 & 0.475 \\
\bottomrule
\multicolumn{8}{l}{\footnotesize $^{\ddagger}$\,MRR@10 for Chemistry Retrieval; NDCG@10 for Open-domain Retrieval (multiple relevant documents per query). ChemRxiv Retrieval and ChemHotpotQA have one relevant document per query; ChemNQ averages 1.3.}\\
\multicolumn{8}{l}{\footnotesize $^{\dagger}$ ChemTEB(latest) comprises ChemRxiv Retrieval and two encyclopedic tasks; individual ChemRxiv Retrieval scores appear in Table~\ref{tab:chemrxiv-results}.}\\
\end{tabular}}
\end{table*}
