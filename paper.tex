...
% We sought a chemistry-interpretable view of the behaviour learned during ChEmbed training. Specifically, we asked 
...
% The resulting 1,554 queries each ranked all 44,887 descriptions using Nomic, ChEmbed\textsubscript{vanilla}, and ChEmbed\textsubscript{progressive}. 
