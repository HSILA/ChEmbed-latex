...
\begin{itemize}
    \item \textbf{Model Weights:} The fine-tuned model weights for all ChEmbed variants (supporting the "LLM fine-tuning" guidelines) are available on Hugging Face at \href{https://huggingface.co/collections/BASF-AI/chembed}{huggingface.co/collections/BASF-AI/chembed}.
    \item \textbf{Training Data:} The complete training datasets, including the 1.7 million synthetic query-passage pairs generated via LLMs, are hosted at \href{https://huggingface.co/collections/BASF-AI/chembed-training-data}{huggingface.co/collections/BASF-AI/chembed-training-data}.
    ...
    \item \textbf{Codebase:} The training and evaluation code, including the fine-tuning recipes, is hosted at \href{https://github.com/HSILA/ChEmbed}{github.com/HSILA/ChEmbed}.
    ...
    \item \textbf{Evaluation Results:} The raw evaluation results and scripts used to generate the manuscript tables and plots can be found at \href{https://github.com/HSILA/ChEmbed-Results}{github.com/HSILA/ChEmbed-Results}.
\end{itemize}
